...
class Chess:
    ...
    def addThemeChoicesToSettingsPopUp(self):
        self.popUp.extend([\  # Choices of Theme
    ...
    def addColorChoicesToSettingsPopUp(self):
        self.popUp.extend([\  # Choices of Color
    ...
    def addVariantChoicesToSettingsPopUp(self):
        self.popUp.extend([\  # Choices of Variant
...
def main():
    print("Please run the Chess_by_Juho_Kim.pyde file to run the program.")
